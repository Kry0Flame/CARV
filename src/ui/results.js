 ...
 * textContent or createElement so a malformed/malicious PDF can't inject HTML.
 */
export function renderResults(r) {
  ...
  setText('cSeam', r.seamAngle + '°');
  setText('cSeamSub', r.seamDetected
    ? (r.seamMethod || 'Entered manually')
  ...
  document.getElementById('seamWarn').style.display = r.seamDetected ? 'none' : 'block';
